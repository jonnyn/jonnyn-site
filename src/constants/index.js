...
const PAST_PROJECTS_GALLERY = [
    { id: '1', src: OPENVIDEO_IMAGES, thumbnail: thumb01, caption: 'Video Streaming App', description: 'Working on a Netflix-like application using React Native/Expo/Redux. The app will stream video from open source APIs'},
    { id: '2', src: '', thumbnail: '',caption: 'US Driving Theory Test', description: 'Using React Native / Redux / Expo to write a theory driving test for all States of U.S., including all vehicle types.'},
    { id: '3', src: CITIZENSHIP_IMAGES, thumbnail: thumb02,caption: 'Canadian Citizenship Test', description: 'Rewrite the app using React Native from the original Android and iOS (Swift) apps'},
    { id: '4', src: '', thumbnail: '',caption: 'Australian Citizenship Test', description: ''},
    { id: '5', src: '', thumbnail: '',caption: 'Life in the UK Test', description: ''},
    { id: '6', src: '', thumbnail: '',caption: 'US Naturalization Citizenship Test', description: ''},
    { id: '7', src: CATCHTHEM_IMAGES, thumbnail: thumb07,caption: 'Catch Them Game', description: 'Catching fruits game. The subject of the game is to catch as much fruits as you can and avoid bombing, TNT.'},
    { id: '8', src: '', thumbnail: '',caption: 'Adobe WWSC 2017', description: ''},
    { id: '9', src: TLIM_IMAGES, thumbnail: thumb03, caption: 'Franklin Covey - The Leader In Me', description: 'One of three main developers in Agile team of 12. Responsible for building reusable AEM components and templates, building complex community page and post builder, as well as overall stability and performance of the site. Developed using AEM 6.1, Java, Apache Sling Servlets, Sightly, JS, JQuery, Handlebars, Bootstrap, and SCSS'},
    { id: '10', src: '', thumbnail: '',caption: 'AEM Cloud Storage', description: ''},
    { id: '11', src: EPIX_IMAGES, thumbnail: thumb04, caption: 'Epix', description: 'Developer on a team of two to create an Android app to act as a front end for ' + 
    'the Epix collection of movies and TV shows. The app allowed the user to browse, favourite, and watch movies and TV shows on their android device. ' +
    'It was built using the Android SDK ( in Java ) with Eclipse and Android Studio.'},
    { id: '12', src: THISLIFE_IMAGES, thumbnail: thumb05, caption: 'Shutterfly - ThisLife', description: 'Software developer in an Agile team of over 20 members (Android, iOS, UX, QA teams) from both Ensemble and Shutterfly developing a native Android mobile app that helped user to manage and share photos, videos, albums, moments. Responsible for building new features in multiple Agile sprints as well as bug fixes. My role was mainly fixing bugs, improve performance, and build couple features of Android app during 4 months working on the project.'},
    { id: '13', src: '', thumbnail: '',caption: 'Adobe DPS Custom Store Front', description: ''},
    { id: '14', src: '', thumbnail: '',caption: 'Adobe DPS Entitlement Service', description: ''},
    { id: '15', src: PROTEUS_IMAGES, thumbnail: thumb06, caption: 'Proteus - Helius', description: 'Software developer responsible for implementation of add-on features of Android medical app and a web administration tools; ensuring cross browser compatibility for the web, partner branding, maintaining and bug fixing. The app presents medical data captured from an adhesive patch that monitors a marker embedded in an ingestible placebo. The placebo is ingested along with doses of a medicine so that the time of day can be associated with the intake. The patch can also record other medical data which can then be shared, through the app, with other parties.'}
];
